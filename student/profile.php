...
// Kiểm tra quyền (Chỉ cho phép sinh viên)
...
<body>
    <div class="app-container">
        ...
        <main class="main-content">
            <h1 style="margin-bottom: 30px;">Hồ sơ sinh viên</h1>
            ...
            <div class="profile-grid">
                ...
                <div class="profile-card">
                    ...
                    <p style="text-align: center; color: #94a3b8; margin-bottom: 25px;">
                        <span class="status-badge status-active">Sinh viên</span>
                    </p>

                    <div class="info-list">
                        <div class="info-item">
                            <span class="info-label"><i class="fa-solid fa-user"></i> MSSV</span>
                        ...
                        <div class="info-item">
                            <span class="info-label"><i class="fa-solid fa-calendar"></i> Tham gia</span>
